...
using MovieRentalApi.Core.ProjectAggregate;
using MovieRentalApi.Core.Services;
using MovieRentalApi.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace MovieRentalApi.UnitTests.Core.Services
{
